 ...
 */
function xmldb_local_translate_courses_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2021121500) {
        ...
        $dataobject2->plugin = 'local_translate_courses';
        $dataobject2->name = 'namecategory';
        $dataobject2->value = $id;

        $adminsetting = $DB->get_record('config_plugins', array('plugin' => 'local_translate_courses', 'name' => 'namecategory'));
