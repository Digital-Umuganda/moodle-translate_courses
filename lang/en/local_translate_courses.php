...
$string['addcourse'] = 'Translate course';
$string['back'] = 'Back';
...
$string['createcoursefromtemplate'] = 'Translate a course';
...
$string['pluginname'] = 'Course translations';
$string['privacy:metadata'] = 'The Course templates plugin does not store any personal data.';
$string['selectcategorybanner'] = 'Select Languages';
$string['selectsrclang'] = 'Select source language';
$string['selecttgtlang'] = 'Select target language';
$string['selecttranslator'] = 'Select translation engine';
$string['selectmods'] = 'Select modules to translate';
